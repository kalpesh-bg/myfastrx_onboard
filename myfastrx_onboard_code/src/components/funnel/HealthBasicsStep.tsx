      ...
      <div>
        ...
        <div className="flex justify-center gap-4 max-w-lg mx-auto">
          <button
            type="button"
            onClick={() => {
              onUpdate({ takingWeightLossMeds: true });
